...
class ResultCheckerFacadeTest {
    ...
    private final NumberReceieverFacade numberReceieverFacade = mock(NumberReceieverFacade.class);
    ...
    public void it_should_generate_all_players_with_correct_message() {
        ...
        when(winningNumbersGeneratorFacade.generateWinningNumbers()).thenReturn(WinningNumbersDto.builder()
                ...
                .build());
        when(numberReceieverFacade.retrieveAllTicketsByNextDrawDate()).thenReturn(List.of(TicketDto.builder()
                        .hash("001")
                ...
                TicketDto.builder()
                        .hash("002")
                        .numbers(Set.of(1, 2, 5, 7, 3, 6))
                        .drawDate(drawDate)
                        .build(),
                TicketDto.builder()
                        .hash("003")
                        .numbers(Set.of(10, 2, 5, 15, 52, 6))
                        .drawDate(drawDate)
                        .build())
        );
    ...
    public void it_should_generate_result_with_correct_credentials() {
        ...
        when(winningNumbersGeneratorFacade.generateWinningNumbers()).thenReturn(WinningNumbersDto.builder()
                ...
                .build());
        String hash = "001";
        when(numberReceieverFacade.retrieveAllTicketsByNextDrawDate()).thenReturn(
